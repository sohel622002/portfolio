...
export const projects: Project[] = [
  {
    ...
    images: [
      "/project-images/docopilot/doco-pilot-image1.png",
      "/project-images/docopilot/doco-pilot-image2.png",
      "/project-images/docopilot/doco-pilot-image3.png",
      "/project-images/docopilot/doco-pilot-image4.png",
    ],
    imageFit: "contain",
